...
const ChildComponent = ({ value, showDice, showloader }) => {
  ...
  function displayImages() {
    ...
    for (let i = 0; i < Display.length - 2; i++) {
      console.log("1st ind", imagesToShow[Display[i]]);
      ImagesAccToSum.push(imagesToShow[Display[i]]);
    }
